...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // include transparent: true to correctly composite behind DOM
  ...
  // Swapped w-full h-full to our custom class to emulate Tailwind layout
